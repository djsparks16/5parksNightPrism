...
juce::AudioProcessorValueTreeState::ParameterLayout FiveParksVST3AudioProcessor::createParameters()
{
    ...
    p.push_back(pf("fm_amt", "FM Grit", 0.0f, 1.0f, 0.08f));
    ...
    p.push_back(pf("tone_amt", "Tone", 0.0f, 1.0f, 0.34f));
    ...
    p.push_back(pf("dist_drive", "Dist Drive", 0.0f, 1.0f, 0.12f));
    p.push_back(pf("dist_mix", "Dist Mix", 0.0f, 1.0f, 0.24f));
    p.push_back(pf("chorus_mix", "Chorus Mix", 0.0f, 1.0f, 0.10f));
    p.push_back(pf("delay_mix", "Delay Mix", 0.0f, 1.0f, 0.08f));
